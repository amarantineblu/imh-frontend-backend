...
class BusinessUtil extends Util
{
    ...
    public function allCurrencies()
    {
        ...
        return $currencies->map(function ($text, $value) {
            return [
                'value' => (string) $value,
                'text' => $text,
            ];
    ...
    /**
     * Gives a list of all accounting methods
     *
     * @return array
     */
    public function allAccountingMethods()
    {
        ...
        return [
            [
                'value' => 'fifo',
                'text' => __('business.fifo'),
            ],
            [
                'value' => 'lifo',
                'text' => __('business.lifo'),
            ],
        ];
    }
    ...
    public function addLocation($business_id, $location_details, $invoice_scheme_id = null, $invoice_layout_id = null)
    {
        ...
        $location = BusinessLocation::create(['business_id' => $business_id,
            'name' => $location_details['business_name'],
