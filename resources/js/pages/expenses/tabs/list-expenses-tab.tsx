...
interface Contacts extends Record<string, unknown>{
...
interface ListExpensesTabProps {
  expenses: Expense[];
  contacts: Contacts[];
}
export default function ListExpensesTab(props: ListExpensesTabProps) {
  const { expenses: mockExpenses , contacts: contactsProp } = props;
